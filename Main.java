public class Main {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        Tester.ErrorCreatingCharacter errorCreatingCharacter = new Tester.ErrorCreatingCharacter();
        try{
            errorCreatingCharacter.testerName();
        }catch (Tester.ErrorCreatingCharacter e) {
            System.out.println(e.getMessage());
        }
        Character character = new Character("DEFAULT");
        System.out.println(character.hello);
        Wizard wizard = new Wizard("");
        System.out.println(wizard.hello);
        Archer archer = new Archer("");
        System.out.println(archer.hello);
    }
}
